      ...
      <section className="w-full h-[40%] flex justify-center items-start flex-col relative">
        ...
        <div class="h-[60%] flex justify-center items-center w-full flex-col ">
          <header className="flex justify-center items-center flex-col gap-5">
            ...
            <h3 className="font-bold mt-1 mb-4">
              Keep you and your friends on track.
            </h3>
          </header>
          <div>
            <button
              className="bg-white-accent w-35 h-10 rounded-[0.5vh] text-black-text font-semibold hover:opacity-[0.9] "
              onClick={() => {
                window.location.href = "https://github.com/helium-ops/Univo";
              }}
            >
              Help them out
            </button>
